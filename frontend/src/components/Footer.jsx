...
const SOCIAL_LINKS = [
  {
    name: "Facebook",
    url: "https://www.facebook.com/share/1EaZpJip4E/",
    icon: (
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/v3lo_ura?igsh=eHp4bHB5NHczeGUz",
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
  ...
  {
    name: "TikTok",
    url: "https://www.tiktok.com/@ve3_loura?_r=1&_t=ZS-98kcl0OBKS8",
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
    ...
    <footer className="footer-v">
      <div className="container-v">
        ...
        <div className="footer-v__bottom">
          ...
          <span className="footer-v__credit">
            {" "}
            · Developed by <span aria-hidden="true">❤</span>{" "}
            <a href="https://www.facebook.com/adhm.mhmd.594072" target="_blank" rel="noopener noreferrer">
              Adham
            </a>
          </span>
        </div>
