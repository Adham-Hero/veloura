...
const SOCIAL_LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        <path d="M16.6 5.82a4.28 4.28 0 0 1-3.13-1.4 4.28 4.28 0 0 1-1.1-2.79h-3.2v13.34a2.6 2.6 0 1 1-1.8-2.47V9.44a5.8 5.8 0 1 0 5 5.74V9.6a7.28 7.28 0 0 0 4.23 1.35V7.75a4.3 4.3 0 0 1-.36.02 4.28 4.28 0 0 1-3.14-1.4c1.03.75 2.16 1.4-1.5-.55Z" />
      </svg>
    ),
  },
  {
